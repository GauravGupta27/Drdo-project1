...
public class JoiningDetail extends HttpServlet
{
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
    {
        ...
        String q="select JOINING.name,JOINING.f_name,JOINING.dob,JOINING.e_mail,JOINING.contactno from JOINING,"+s1+" where JOINING.e_mail="+s1+".e_mail";
