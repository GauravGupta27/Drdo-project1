...
<div id="section">
    ...
    <P>  You have successfully submitted your form.You will recieve an <br>
     email if you will be selected for the interview.Selection is fully <br>
     based on your Resume and Academic result .<br>
     Thank you,
    <br>
    <br>
